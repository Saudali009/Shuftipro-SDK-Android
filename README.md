...
* <h3>event</h3>
	This is the request event which shows status of request. Event is changed in every response. Please consult [Status Codes](https://github.com/Saudali009/Shuftipro-SDK-Android/edit/master/status_codes.md) for more information.
